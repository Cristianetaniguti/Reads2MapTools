...
#' @param rm_just_noninfo filter out only non-informative markers
#' 
#' @import vcfR
#' @export 
segregation_test_vcf <- function(vcf, threshold, P1, P2, out.vcf = "filtered.vcf.gz", rm_just_noninfo = FALSE){
  obj <- read.vcfR(vcf)
